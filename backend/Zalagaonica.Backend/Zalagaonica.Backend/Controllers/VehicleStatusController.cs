...
namespace Zalagaonica.Backend.Controllers
{
    ...
    {
        private readonly VehicleStatusService _service;
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] VehicleStatus model)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(Guid id, [FromBody] VehicleStatus model)
        {
