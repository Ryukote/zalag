...
namespace Zalagaonica.Backend.Controllers
{
    ...
    {
        private readonly ReservationStatusService _service;
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] ReservationStatus model)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(Guid id, [FromBody] ReservationStatus model)
        {
