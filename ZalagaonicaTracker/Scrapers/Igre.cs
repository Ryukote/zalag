...
namespace ZalagaonicaTracker.Scrapers
{
    public static class Igre
    {
        ...
        private static string GetEncodedIgreIndexZagrebUrl(int page)
        {
            try
            {
        ...
        private static string GetEncodedIgreIndexKarlovacUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedIgreIndexRijekaIstraUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedIgreIndexZadarLikaUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedIgreIndexDubrovnikSplitUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedIgreIndexKrapinskoZagorskaUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedIgreIndexSisackoMoslavackaUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedIgreIndexBjelovarskaMedimurskaVarazdinskaUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetIgreZagrebUrl(int page)
        {
            return $"https://www.njuskalo.hr/igre-igrice?geo%5BlocationIds%5D=1153&page={page}";
        }

        private static string GetIgreKarlovacUrl(int page)
        {
            return $"https://www.njuskalo.hr/igre-igrice?geo%5BlocationIds%5D=1155&page={page}";
        }

        private static string GetIgreRijekaIstraUrl(int page)
        {
            return $"https://www.njuskalo.hr/igre-igrice?geo%5BlocationIds%5D=1162%2C1154&page={page}";
        }

        private static string GetIgreZadarLikaUrl(int page)
        {
            return $"https://www.njuskalo.hr/igre-igrice?geo%5BlocationIds%5D=1169%2C1158&page={page}";
        }

        private static string GetIgreDubrovnikSplitUrl(int page)
        {
            return $"https://www.njuskalo.hr/igre-igrice?geo%5BlocationIds%5D=1152%2C1164&page={page}";
        }

        private static string GetIgreKrapinskoZagorskaUrl(int page)
        {
            return $"https://www.njuskalo.hr/igre-igrice?geo%5BlocationIds%5D=1157&page={page}";
        }

        private static string GetIgreSisackoMoslavackaUrl(int page)
        {
            return $"https://www.njuskalo.hr/igre-igrice?geo%5BlocationIds%5D=1163&page={page}";
        }

        private static string GetIgreBjelovarskaMedimurskaVarazdinskaUrl(int page)
        {
            return $"https://www.njuskalo.hr/igre-igrice?geo%5BlocationIds%5D=1150%2C1159%2C1166&page={page}";
        }
        ...
        public static async Task<List<AdData>> IgreIndexZagreb(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Igre ads on Index in Zagreb");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedIgreIndexZagrebUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
            ...
            //        while (true)
            //        {
            //            await pageInstance.GotoAsync(GetEncodedIgreIndexZagrebUrl(page), new() { Timeout = 30000 });
        ...
        public static async Task<List<AdData>> IgreIndexKarlovac(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Igre ads on Index in Karlovac");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedIgreIndexKarlovacUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
            ...
            //        while (true)
            //        {
            //            await pageInstance.GotoAsync(GetEncodedIgreIndexKarlovacUrl(page), new() { Timeout = 30000 });
        ...
        public static async Task<List<AdData>> IgreIndexRijekaIstra(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Igre ads on Index in Rijeka and Istra");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedIgreIndexRijekaIstraUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
            ...
            //        while (true)
            //        {
            //            await pageInstance.GotoAsync(GetEncodedIgreIndexRijekaIstraUrl(page), new() { Timeout = 30000 });
        ...
        public static async Task<List<AdData>> IgreIndexZadarLika(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Igre ads on Index in Zadar and Lika");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedIgreIndexZadarLikaUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
            ...
            //        while (true)
            //        {
            //            await pageInstance.GotoAsync(GetEncodedIgreIndexZadarLikaUrl(page), new() { Timeout = 30000 });
        ...
        public static async Task<List<AdData>> IgreIndexDubrovnikSplit(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Igre ads on Index in Dubrovnik and Split");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedIgreIndexDubrovnikSplitUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
            ...
            //        while (true)
            //        {
            //            await pageInstance.GotoAsync(GetEncodedIgreIndexDubrovnikSplitUrl(page), new() { Timeout = 30000 });
        ...
        public static async Task<List<AdData>> IgreIndexKrapinskoZagorska(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Igre ads on Index in Krapinsko Zagorska");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedIgreIndexKrapinskoZagorskaUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
            ...
            //        while (true)
            //        {
            //            await pageInstance.GotoAsync(GetEncodedIgreIndexKrapinskoZagorskaUrl(page), new() { Timeout = 30000 });
        ...
        public static async Task<List<AdData>> IgreIndexSisackoMoslavacka(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Igre ads on Index in Sisačko Moslavačka");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedIgreIndexSisackoMoslavackaUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
            ...
            //        while (true)
            //        {
            //            await pageInstance.GotoAsync(GetEncodedIgreIndexSisackoMoslavackaUrl(page), new() { Timeout = 30000 });
        ...
        public static async Task<List<AdData>> IgreIndexBjelovarskaMedimurskaVarazdinska(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Igre ads on Index in Bjelovarska, Međimurska and Varaždinska");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedIgreIndexBjelovarskaMedimurskaVarazdinskaUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
            ...
            //        using var pw = await Playwright.CreateAsync();
            //        await using var browser = await pw.Chromium.ConnectOverCDPAsync(SBR_CDP);
            //        Console.WriteLine("Connected! Navigating and scrapping Igre ads on Index in Bjelovarska, Međimurska and Varaždinska županija");
            ...
            //        while (true)
            //        {
            //            await pageInstance.GotoAsync(GetEncodedIgreIndexBjelovarskaMedimurskaVarazdinskaUrl(page), new() { Timeout = 30000 });
        ...
        public static async Task<List<AdData>> GetIgreLaptopiZagreb()
        {
            return await GetNjuskaloData(GetIgreZagrebUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloIgreKarlovac()
        {
            return await GetNjuskaloData(GetIgreKarlovacUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloIgreRijekaIstra()
        {
            return await GetNjuskaloData(GetIgreRijekaIstraUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloIgreZadarLika()
        {
            return await GetNjuskaloData(GetIgreZadarLikaUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloIgreDubrovnikSplit()
        {
            return await GetNjuskaloData(GetIgreDubrovnikSplitUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloIgreKrapinskoZagorska()
        {
            return await GetNjuskaloData(GetIgreKrapinskoZagorskaUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloIgreSisackoMoslavacka()
        {
            return await GetNjuskaloData(GetIgreSisackoMoslavackaUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloIgreBjelovarskaMedimurskaVarazdinska()
        {
            return await GetNjuskaloData(GetIgreBjelovarskaMedimurskaVarazdinskaUrl(1), 1);
        }
    }
}
