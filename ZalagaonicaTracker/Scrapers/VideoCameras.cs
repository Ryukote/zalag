...
{
    public static class VideoCameras
    {
        ...
        private static string GetEncodedVideoCameraIndexZagrebUrl(int page)
        {
            try
            {
        ...
        private static string GetEncodedVideoCameraIndexKarlovacUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedVideoCameraIndexRijekaIstraUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedVideoCameraIndexZadarLikaUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedVideoCameraIndexDubrovnikSplitUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedVideoCameraIndexKrapinskoZagorskaUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedVideoCameraIndexSisackoMoslavackaUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedVideoCameraIndexBjelovarskaMedimurskaVarazdinskaUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetVideoCameraZagrebUrl(int page)
        {
            return $"https://www.njuskalo.hr/video-kamere?geo%5BlocationIds%5D=1153&price%5Bmin%5D=100&page={page}";
        }

        private static string GetVideoCameraKarlovacUrl(int page)
        {
            return $"https://www.njuskalo.hr/video-kamere?geo%5BlocationIds%5D=1155&price%5Bmin%5D=100&page={page}";
        }

        private static string GetVideoCameraRijekaIstraUrl(int page)
        {
            return $"https://www.njuskalo.hr/video-kamere?geo%5BlocationIds%5D=1162%2C1154&price%5Bmin%5D=100&page={page}";
        }

        private static string GetVideoCameraZadarLikaUrl(int page)
        {
            return $"https://www.njuskalo.hr/video-kamere?geo%5BlocationIds%5D=1169%2C1158&price%5Bmin%5D=100&page={page}";
        }

        private static string GetVideoCameraDubrovnikSplitUrl(int page)
        {
            return $"https://www.njuskalo.hr/video-kamere?geo%5BlocationIds%5D=1152%2C1164&price%5Bmin%5D=100&page={page}";
        }

        private static string GetVideoCameraKrapinskoZagorskaUrl(int page)
        {
            return $"https://www.njuskalo.hr/video-kamere?geo%5BlocationIds%5D=1157&price%5Bmin%5D=100&page={page}";
        }

        private static string GetVideoCameraSisackoMoslavackaUrl(int page)
        {
            return $"https://www.njuskalo.hr/video-kamere?geo%5BlocationIds%5D=1163&price%5Bmin%5D=100&page={page}";
        }

        private static string GetVideoCameraBjelovarskaMedimurskaVarazdinskaUrl(int page)
        {
            return $"https://www.njuskalo.hr/video-kamere?geo%5BlocationIds%5D=1150%2C1159%2C1166&price%5Bmin%5D=100&page={page}";
        }
        ...
        private static async Task<AdData> GetAdInfo(AdData adData)
        {
            try
            {
                ...
                try
                {
                    ...
                    Console.WriteLine($"Connected! Navigating and scrapping Video kamera ad detail on Index {adData.Location}");
        ...
        public static async Task<List<AdData>> VideKameraIndexZagreb(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Video kamera ads on Index in Zagreb");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedVideoCameraIndexZagrebUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
            ...
            //        while (true)
            //        {
            //            await pageInstance.GotoAsync(GetEncodedVideoCameraIndexZagrebUrl(page), new() { Timeout = 30000 });
        ...
        public static async Task<List<AdData>> VideoKameraIndexKarlovac(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Video kamera ads on Index in Karlovac");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedVideoCameraIndexKarlovacUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
            ...
            //        while (true)
            //        {
            //            await pageInstance.GotoAsync(GetEncodedVideoCameraIndexKarlovacUrl(page), new() { Timeout = 30000 });
        ...
        public static async Task<List<AdData>> VideoKameraIndexRijekaIstra(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Video kamera ads on Index in Rijeka and Istra");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedVideoCameraIndexRijekaIstraUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
            ...
            //        while (true)
            //        {
            //            await pageInstance.GotoAsync(GetEncodedVideoCameraIndexRijekaIstraUrl(page), new() { Timeout = 30000 });
        ...
        public static async Task<List<AdData>> VideoKameraIndexZadarLika(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Video kamera ads on Index in Zadar and Lika");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedVideoCameraIndexZadarLikaUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
            ...
            //        while (true)
            //        {
            //            await pageInstance.GotoAsync(GetEncodedVideoCameraIndexZadarLikaUrl(page), new() { Timeout = 30000 });
        ...
        public static async Task<List<AdData>> VideoKameraIndexDubrovnikSplit(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Video kamera ads on Index in Dubrovnik and Split");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedVideoCameraIndexDubrovnikSplitUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
            ...
            //        while (true)
            //        {
            //            await pageInstance.GotoAsync(GetEncodedVideoCameraIndexDubrovnikSplitUrl(page), new() { Timeout = 30000 });
        ...
        public static async Task<List<AdData>> VideoKameraIndexKrapinskoZagorska(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Video kamera ads on Index in Krapinsko Zagorska");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedVideoCameraIndexKrapinskoZagorskaUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
            ...
            //        using var pw = await Playwright.CreateAsync();
            //        await using var browser = await pw.Chromium.ConnectOverCDPAsync(SBR_CDP);
            //        Console.WriteLine("Connected! Navigating and scrapping Tableti ads on Index in Dubrovnik and Split");
            ...
            //        while (true)
            //        {
            //            await pageInstance.GotoAsync(GetEncodedVideoCameraIndexKrapinskoZagorskaUrl(page), new() { Timeout = 30000 });
        ...
        public static async Task<List<AdData>> VideoKameraIndexSisackoMoslavacka(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Video kamera ads on Index in Sisačko Moslavačka");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedVideoCameraIndexSisackoMoslavackaUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
            ...
            //        using var pw = await Playwright.CreateAsync();
            //        await using var browser = await pw.Chromium.ConnectOverCDPAsync(SBR_CDP);
            //        Console.WriteLine("Connected! Navigating and scrapping Video kamera ads on Index in Sisak and Moslavina");
            ...
            //        while (true)
            //        {
            //            await pageInstance.GotoAsync(GetEncodedVideoCameraIndexSisackoMoslavackaUrl(page), new() { Timeout = 30000 });
        ...
        public static async Task<List<AdData>> VideoKameraIndexBjelovarskaMedimurskaVarazdinska(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Video kamera ads on Index in Bjelovarska, Međimurska and Varaždinska");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedVideoCameraIndexBjelovarskaMedimurskaVarazdinskaUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
            ...
            //        using var pw = await Playwright.CreateAsync();
            //        await using var browser = await pw.Chromium.ConnectOverCDPAsync(SBR_CDP);
            //        Console.WriteLine("Connected! Navigating and scrapping Tableti ads on Index in Bjelovarska, Međimurska and Varaždinska županija");
            ...
            //        while (true)
            //        {
            //            await pageInstance.GotoAsync(GetEncodedVideoCameraIndexBjelovarskaMedimurskaVarazdinskaUrl(page), new() { Timeout = 30000 });
        ...
        public static async Task<List<AdData>> GetNjuskaloVideoCameraZagreb()
        {
            return await GetNjuskaloData(GetVideoCameraZagrebUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloVideoCameraKarlovac()
        {
            return await GetNjuskaloData(GetVideoCameraKarlovacUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloVideoCameraRijekaIstra()
        {
            return await GetNjuskaloData(GetVideoCameraRijekaIstraUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloVideoCameraZadarLika()
        {
            return await GetNjuskaloData(GetVideoCameraZadarLikaUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloVideoCameraDubrovnikSplit()
        {
            return await GetNjuskaloData(GetVideoCameraDubrovnikSplitUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloVideoCameraKrapinskoZagorska()
        {
            return await GetNjuskaloData(GetVideoCameraKrapinskoZagorskaUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloVideoCameraSisackoMoslavacka()
        {
            return await GetNjuskaloData(GetVideoCameraSisackoMoslavackaUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloVideoCameraBjelovarskaMedimurskaVarazdinska()
        {
            return await GetNjuskaloData(GetVideoCameraBjelovarskaMedimurskaVarazdinskaUrl(1), 1);
        }
    }
}
