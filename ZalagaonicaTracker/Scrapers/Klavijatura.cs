...
{
    public static class Klavijatura
    {
        ...
        private static string GetEncodedKlavijaturaIndexZagrebUrl(int page)
        {
            try
            {
                ...
                string query = $@"
                    {{
                        ""text"": ""klavijatura"",
                        ""category"": ""musical-instruments-and-equipment"",
                        ""module"": ""things"",
                        ""priceFrom"": 100,
        ...
        private static string GetEncodedKlavijaturaIndexKarlovacUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedKlavijaturaIndexRijekaIstraUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedKlavijaturaIndexZadarLikaUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedKlavijaturaIndexDubrovnikSplitUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedKlavijaturaIndexKrapinskoZagorskaUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedKlavijaturaGlazbalaIndexSisackoMoslavackaUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedKlavijaturaIndexBjelovarskaMedimurskaVarazdinskaUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetKlavijaturaZagrebUrl(int page)
        {
            return $"https://www.njuskalo.hr/klavijature?geo%5BlocationIds%5D=1153&price%5Bmin%5D=100&page={page}";
        }

        private static string GetKlavijaturaKarlovacUrl(int page)
        {
            return $"https://www.njuskalo.hr/klavijature?geo%5BlocationIds%5D=1155&price%5Bmin%5D=100&page={page}";
        }

        private static string GetKlavijaturaRijekaIstraUrl(int page)
        {
            return $"https://www.njuskalo.hr/klavijature?geo%5BlocationIds%5D=1162%2C1154&price%5Bmin%5D=100&page={page}";
        }

        private static string GetKlavijaturaZadarLikaUrl(int page)
        {
            return $"https://www.njuskalo.hr/klavijature?geo%5BlocationIds%5D=1169%2C1158&price%5Bmin%5D=100&page={page}";
        }

        private static string GetKlavijaturaDubrovnikSplitUrl(int page)
        {
            return $"https://www.njuskalo.hr/klavijature?geo%5BlocationIds%5D=1152%2C1164&price%5Bmin%5D=100&page={page}";
        }

        private static string GetKlavijaturaKrapinskoZagorskaUrl(int page)
        {
            return $"https://www.njuskalo.hr/klavijature?geo%5BlocationIds%5D=1157&price%5Bmin%5D=100&page={page}";
        }

        private static string GetKlavijaturalaSisackoMoslavackaUrl(int page)
        {
            return $"https://www.njuskalo.hr/klavijature?geo%5BlocationIds%5D=1163&price%5Bmin%5D=100&page={page}";
        }

        private static string GetKlavijaturaBjelovarskaMedimurskaVarazdinskaUrl(int page)
        {
            return $"https://www.njuskalo.hr/klavijature?geo%5BlocationIds%5D=1150%2C1159%2C1166&price%5Bmin%5D=100&page={page}";
        }
        ...
        private static async Task<AdData> GetAdInfo(AdData adData)
        {
            try
            {
                ...
                try
                {
                    ...
                    Console.WriteLine($"Connected! Navigating and scrapping Klavijatura ad detail on Index {adData.Location}");
        ...
        public static async Task<List<AdData>> KlavijaturaIndexZagreb(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Klavijatura ads on Index in Zagreb");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedKlavijaturaIndexZagrebUrl(page), new NavigationOptions
                        {
            ...
            //        while (true)
            //        {
            //            await pageInstance.GotoAsync(GetEncodedKlavijaturaIndexZagrebUrl(page), new() { Timeout = 30000 });
        ...
        public static async Task<List<AdData>> KlavijaturaIndexKarlovac(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Klavijatura ads on Index in Karlovac");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedKlavijaturaIndexKarlovacUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
            ...
            //        while (true)
            //        {
            //            await pageInstance.GotoAsync(GetEncodedKlavijaturaIndexKarlovacUrl(page), new() { Timeout = 30000 });
        ...
        public static async Task<List<AdData>> KlavijaturaIndexRijekaIstra(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping KLavijatura ads on Index in Rijeka and Istra");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedKlavijaturaIndexRijekaIstraUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
            ...
            //        while (true)
            //        {
            //            await pageInstance.GotoAsync(GetEncodedKlavijaturaIndexRijekaIstraUrl(page), new() { Timeout = 30000 });
        ...
        public static async Task<List<AdData>> KlavijaturaIndexZadarLika(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Klavijatura ads on Index in Zadar and Lika");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedKlavijaturaIndexZadarLikaUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
            ...
            //        while (true)
            //        {
            //            await pageInstance.GotoAsync(GetEncodedKlavijaturaIndexZadarLikaUrl(page), new() { Timeout = 30000 });
        ...
        public static async Task<List<AdData>> KlavijaturaIndexDubrovnikSplit(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Klavijature ads on Index in Dubrovnik and Split");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedKlavijaturaIndexDubrovnikSplitUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
            ...
            //        using var pw = await Playwright.CreateAsync();
            //        await using var browser = await pw.Chromium.ConnectOverCDPAsync(SBR_CDP);
            //        Console.WriteLine("Connected! Navigating and scrapping Klavijatura ads on Index in Dubrovnik and Split");
            ...
            //        while (true)
            //        {
            //            await pageInstance.GotoAsync(GetEncodedKlavijaturaIndexDubrovnikSplitUrl(page), new() { Timeout = 30000 });
        ...
        public static async Task<List<AdData>> KlavijaturaIndexKrapinskoZagorska(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Klavijatura ads on Index in Krapinsko Zagorska");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedKlavijaturaIndexKrapinskoZagorskaUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
            ...
            //        using var pw = await Playwright.CreateAsync();
            //        await using var browser = await pw.Chromium.ConnectOverCDPAsync(SBR_CDP);
            //        Console.WriteLine("Connected! Navigating and scrapping Klavijatura ads on Index in Krapina and Zagorje");
            ...
            //        while (true)
            //        {
            //            await pageInstance.GotoAsync(GetEncodedKlavijaturaIndexKrapinskoZagorskaUrl(page), new() { Timeout = 30000 });
        ...
        public static async Task<List<AdData>> KlavijaturaIndexSisackoMoslavacka(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Klavijatura ads on Index in Sisačko Moslavačka");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedKlavijaturaGlazbalaIndexSisackoMoslavackaUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
            ...
            //        using var pw = await Playwright.CreateAsync();
            //        await using var browser = await pw.Chromium.ConnectOverCDPAsync(SBR_CDP);
            //        Console.WriteLine("Connected! Navigating and scrapping Klavijatura ads on Index in Sisak and Moslavina");
            ...
            //        while (true)
            //        {
            //            await pageInstance.GotoAsync(GetEncodedKlavijaturaGlazbalaIndexSisackoMoslavackaUrl(page), new() { Timeout = 30000 });
        ...
        public static async Task<List<AdData>> KlavijaturaIndexBjelovarskaMedimurskaVarazdinska(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Klavijatura ads on Index in Bjelovarska, Međimurska and Varaždinska");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedKlavijaturaIndexBjelovarskaMedimurskaVarazdinskaUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
            ...
            //        using var pw = await Playwright.CreateAsync();
            //        await using var browser = await pw.Chromium.ConnectOverCDPAsync(SBR_CDP);
            //        Console.WriteLine("Connected! Navigating and scrapping Klavijatura ads on Index in Bjelovarska, Međimurska and Varaždinska županija");
            ...
            //        while (true)
            //        {
            //            await pageInstance.GotoAsync(GetEncodedKlavijaturaIndexBjelovarskaMedimurskaVarazdinskaUrl(page), new() { Timeout = 30000 });
        ...
        public static async Task<List<AdData>> GetNjuskaloKlavijaturaZagreb()
        {
            return await GetNjuskaloData(GetKlavijaturaZagrebUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloKlavijaturaKarlovac()
        {
            return await GetNjuskaloData(GetKlavijaturaKarlovacUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloKlavijaturaRijekaIstra()
        {
            return await GetNjuskaloData(GetKlavijaturaRijekaIstraUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloKlavijaturaZadarLika()
        {
            return await GetNjuskaloData(GetKlavijaturaZadarLikaUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloKlavijaturaDubrovnikSplit()
        {
            return await GetNjuskaloData(GetKlavijaturaDubrovnikSplitUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloKlavijaturaKrapinskoZagorska()
        {
            return await GetNjuskaloData(GetKlavijaturaKrapinskoZagorskaUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloKlavijaturaSisackoMoslavacka()
        {
            return await GetNjuskaloData(GetKlavijaturalaSisackoMoslavackaUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloKlavijaturaBjelovarskaMedimurskaVarazdinska()
        {
            return await GetNjuskaloData(GetKlavijaturaBjelovarskaMedimurskaVarazdinskaUrl(1), 1);
        }
    }
}
