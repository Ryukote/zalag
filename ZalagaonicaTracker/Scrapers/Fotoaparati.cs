...
{
    public static class Fotoaparati
    {
        private static List<string> authList = new List<string>
        {
            "brd-customer-hl_615a7fb5-zone-scraping_browser5:mmfwt99zia9u"
        };
        ...
        private static string GetEncodedFotoaparatiIndexZagrebUrl(int page)
        {
            try
            {
        ...
        private static string GetEncodedFotoaparatiIndexKarlovacUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedFotoaparatiIndexRijekaIstraUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedFotoaparatiIndexZadarLikaUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedFotoaparatiIndexDubrovnikSplitUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedFotoaparatiIndexKrapinskoZagorskaUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedVideoFotoaparatiIndexSisackoMoslavackaUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedFotoaparatiIndexBjelovarskaMedimurskaVarazdinskaUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetFotoaparatiZagrebUrl(int page)
        {
            return $"https://www.njuskalo.hr/foto?geo%5BlocationIds%5D=1153&price%5Bmin%5D=200&page={page}";
        }

        private static string GetFotoaparatiKarlovacUrl(int page)
        {
            return $"https://www.njuskalo.hr/foto?geo%5BlocationIds%5D=1155&price%5Bmin%5D=200&page={page}";
        }

        private static string GetFotoaparatiRijekaIstraUrl(int page)
        {
            return $"https://www.njuskalo.hr/foto?geo%5BlocationIds%5D=1162%2C1154&price%5Bmin%5D=200&page={page}";
        }

        private static string GetFotoaparatiZadarLikaUrl(int page)
        {
            return $"https://www.njuskalo.hr/foto?geo%5BlocationIds%5D=1169%2C1158&price%5Bmin%5D=200&page={page}";
        }

        private static string GetFotoaparatiDubrovnikSplitUrl(int page)
        {
            return $"https://www.njuskalo.hr/foto?geo%5BlocationIds%5D=1152%2C1164&price%5Bmin%5D=200&page={page}";
        }

        private static string GetFotoaparatiKrapinskoZagorskaUrl(int page)
        {
            return $"https://www.njuskalo.hr/foto?geo%5BlocationIds%5D=1157&price%5Bmin%5D=200&page={page}";
        }

        private static string GetFotoaparatiSisackoMoslavackaUrl(int page)
        {
            return $"https://www.njuskalo.hr/foto?geo%5BlocationIds%5D=1163&price%5Bmin%5D=200&page={page}";
        }

        private static string GetFotoaparatiBjelovarskaMedimurskaVarazdinskaUrl(int page)
        {
            return $"https://www.njuskalo.hr/foto?geo%5BlocationIds%5D=1150%2C1159%2C1166&price%5Bmin%5D=200&page={page}";
        }
        ...
        private static async Task<AdData> GetNjuskaloAdInfo(List<string> usernames, string url, AdData data)
        {
            try
            {
                ServicePointManager.ServerCertificateValidationCallback += (sender, cert, chain, sslPolicyErrors) => true;
                ...
                if (usernames.Where(x => x == sellerUsername).Count() == 0)
                {
                    await Task.Delay(200);
                    ...
                    if (node != null)
                    {
                        ...
                        if (match.Success)
                        {
                            Console.WriteLine("User ID: " + match.Groups[0].Value);
                            ...
                            using (WebClient userClient = new WebClient())
                            {
                                ...
                                if (dataToken?["attributes"]?["numbers"] is JArray numbers && numbers.Count > 0)
                                {
                                    rawNumber = numbers[0]?["rawNumber"]?.ToString();
                                }
                                ...
                                if (!string.IsNullOrEmpty(rawNumber))
                                {
                                    ...
                                    if (data.Location.Contains("Trešnjevka - Sjever"))
                                    {
                                        if (!string.IsNullOrEmpty(data.PhoneNumber))
                                        {
                                            await SMSClient.SendSMS(data.PhoneNumber, "0993006000");
                                        }

                                    }

                                    else if (data.Location.Contains("Trešnjevka - Jug"))
                                    {
                                        if (!string.IsNullOrEmpty(data.PhoneNumber))
                                        {
                                            await SMSClient.SendSMS(data.PhoneNumber, "0925008000");
                                        }
                                    }

                                    else if (data.Location.Contains("Gornja Dubrava"))
                                    {
                                        if (!string.IsNullOrEmpty(data.PhoneNumber))
                                        {
                                            await SMSClient.SendSMS(data.PhoneNumber, "0977700077");
                                        }
                                    }

                                    else if (data.Location.Contains("Donja Dubrava"))
                                    {
                                        if (!string.IsNullOrEmpty(data.PhoneNumber))
                                        {
                                            await SMSClient.SendSMS(data.PhoneNumber, "0977700077");
                                    ...
                                    else if (data.Location.Contains("Maksimir"))
                                    {
                                        if (!string.IsNullOrEmpty(data.PhoneNumber))
                                        {
                                            await SMSClient.SendSMS(data.PhoneNumber, "0977700077");
                                    ...
                                    else if (data.Location.Contains("Stenjevec"))
                                    {
                                        if (!string.IsNullOrEmpty(data.PhoneNumber))
                                        {
                                            await SMSClient.SendSMS(data.PhoneNumber, "0993006000");
                                    ...
                                    else if (data.Location.Contains("Novi Zagreb - Istok"))
                                    {
                                        if (!string.IsNullOrEmpty(data.PhoneNumber))
                                        {
                                            await SMSClient.SendSMS(data.PhoneNumber, "0925008000");
                                    ...
                                    else if (data.Location.Contains("Podsused - Vrapče"))
                                    {
                                        if (!string.IsNullOrEmpty(data.PhoneNumber))
                                        {
                                            await SMSClient.SendSMS(data.PhoneNumber, "0993006000");
                                    ...
                                    else if (data.Location.Contains("Novi Zagreb - Zapad"))
                                    {
                                        if (!string.IsNullOrEmpty(data.PhoneNumber))
                                        {
                                            await SMSClient.SendSMS(data.PhoneNumber, "0925008000");
                                    ...
                                    else if (data.Location.Contains("Donji Grad"))
                                    {
                                        if (!string.IsNullOrEmpty(data.PhoneNumber))
                                        {
                                            await SMSClient.SendSMS(data.PhoneNumber, "0925000550");
                                        }
                                    }

                                    else if (data.Location.Contains("Brezovica"))
                                    {
                                        if (!string.IsNullOrEmpty(data.PhoneNumber))
                                        {
                                            await SMSClient.SendSMS(data.PhoneNumber, "0925008000");
                                    ...
                                    else if (data.Location.Contains("Trnje"))
                                    {
                                        if (!string.IsNullOrEmpty(data.PhoneNumber))
                                        {
                                            await SMSClient.SendSMS(data.PhoneNumber, "0925000550");
                                    ...
                                    else if (data.Location.Contains("Podsljeme"))
                                    {
                                        if (!string.IsNullOrEmpty(data.PhoneNumber))
                                        {
                                            await SMSClient.SendSMS(data.PhoneNumber, "0977700077");
                                    ...
                                    else if (data.Location.Contains("Črnomerec"))
                                    {
                                        if (!string.IsNullOrEmpty(data.PhoneNumber))
                                        {
                                            await SMSClient.SendSMS(data.PhoneNumber, "0993006000");
                                    ...
                                    else if (data.Location.Contains("Gornji Grad - Medveščak"))
                                    {
                                        if (!string.IsNullOrEmpty(data.PhoneNumber))
                                        {
                                            await SMSClient.SendSMS(data.PhoneNumber, "0925000550");
            ...
            {
                await GetNjuskaloAdInfo(usernames, url, data);
                return data;
            }
        }

        public static async Task<List<AdData>> GetNjuskaloFotoaparatiZagreb()
        {
            var list = new List<AdData>();
            await GetNjuskaloData(list, GetFotoaparatiZagrebUrl(1), 1);

            return list;
        }

        public static async Task<List<AdData>> GetNjuskaloFotoaparatiKarlovac()
        {
            var list = new List<AdData>();
            await GetNjuskaloData(list, GetFotoaparatiKarlovacUrl(1), 1);

            return list;
        }

        public static async Task<List<AdData>> GetNjuskaloFotoaparatiRijekaIstra()
        {
            var list = new List<AdData>();
            await GetNjuskaloData(list, GetFotoaparatiRijekaIstraUrl(1), 1);

            return list;
        }

        public static async Task<List<AdData>> GetNjuskaloFotoaparatiZadarLika()
        {
            var list = new List<AdData>();
            await GetNjuskaloData(list, GetFotoaparatiZadarLikaUrl(1), 1);

            return list;
        }

        public static async Task<List<AdData>> GetNjuskaloFotoaparatiDubrovnikSplit()
        {
            var list = new List<AdData>();
            await GetNjuskaloData(list, GetFotoaparatiDubrovnikSplitUrl(1), 1);

            return list;
        }

        public static async Task<List<AdData>> GetNjuskaloFotoaparatiKrapinskoZagorska()
        {
            var list = new List<AdData>();
            await GetNjuskaloData(list, GetFotoaparatiKrapinskoZagorskaUrl(1), 1);

            return list;
        }

        public static async Task<List<AdData>> GetNjuskaloFotoaparatiSisackoMoslavacka()
        {
            var list = new List<AdData>();
            await GetNjuskaloData(list, GetFotoaparatiSisackoMoslavackaUrl(1), 1);
            return list;

        }

        public static async Task<List<AdData>> GetNjuskaloFotoaparatiBjelovarskaMedimurskaVarazdinska()
        {
            var list = new List<AdData>();
            await GetNjuskaloData(list, GetFotoaparatiBjelovarskaMedimurskaVarazdinskaUrl(1), 1);
        ...
        //        while (true)
        //        {
        //            url = Regex.Replace(url, @"page=\d+$", $"page={page}"); // Update URL for the new page
        ...
        //            // **EXIT IF NO ADS ARE FOUND**
        //            if (ads == null || ads.Count == 0)
        //            {
        //                Console.WriteLine($"No ads found on page {page}. Exiting...");
        //                return scrapedAds;
        //            }
        ...
        //            if (!hasRecentAds)
        //            {
        //                Console.WriteLine("No recent ads found, stopping...");
        //                return scrapedAds;
        //            }

        //            else
        //            {
        //                await GetNjuskaloData(url, page);
        //            }
        ...
        private static async Task<List<AdData>> GetNjuskaloData(List<AdData> scrapedAds, string url, int page = 1)
        {
            url = Regex.Replace(url, @"page=\d+$", $"page={page}");
                ...
                while (true)
                {
                    ...
                    try
                    {
                        ...
                        foreach (var ad in ads)
                        {
                            ...
                            var descNode = ad.SelectSingleNode(".//div[contains(@class, 'entity-description')]");
                            var urlNode = ad.SelectSingleNode(".//h3/a");
                            var location = ad.SelectSingleNode(".//span[contains(text(), 'Lokacija:')]/following-sibling::text()\r\n");
                            ...
                            try
                            {
                                adData = await GetNjuskaloAdInfo(scrapedAds.Select(x => x.Username).ToList(), adData.URL, adData);
                                if (adData.Views < 500)
                                {
                                    scrapedAds.Add(adData);
                                    hasRecentAds = true;
                    ...
                    // ✅ Properly return the recursive results
                    await Task.Delay(200);
                    scrapedAds.AddRange(await GetNjuskaloData(scrapedAds, url, page));
                    //scrapedAds.AddRange(nextPageResults);
            ...
            catch (Exception ex)
            {
                ...
                return scrapedAds; // ✅ Ensure method always returns
            }
        }


        public static async Task<List<AdData>> FotoaparatiIndexZagreb(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Fotoaparati ads on Index in Zagreb");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedFotoaparatiIndexZagrebUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
        ...
        public static async Task<List<AdData>> FotoaparatiIndexKarlovac(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Fotoaparati ads on Index in Karlovac");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedFotoaparatiIndexKarlovacUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
        ...
        public static async Task<List<AdData>> FotoaparatiIndexRijekaIstra(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Fotoaparati ads on Index in Rijeka and Istra");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedFotoaparatiIndexRijekaIstraUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
        ...
        public static async Task<List<AdData>> FotoaparatiIndexZadarLika(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Fotoaparati ads on Index in Zadar and Lika");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedFotoaparatiIndexZadarLikaUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
        ...
        public static async Task<List<AdData>> FotoaparatiIndexDubrovnikSplit(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Fotoaparati ads on Index in Dubrovnik and Split");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedFotoaparatiIndexDubrovnikSplitUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
        ...
        public static async Task<List<AdData>> FotoaparatiIndexKrapinskoZagorska(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Fotoaparati ads on Index in Krapinsko Zagorska");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedFotoaparatiIndexKrapinskoZagorskaUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
        ...
        public static async Task<List<AdData>> FotoaparatiIndexSisackoMoslavacka(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Fotoaparati ads on Index in Sisačko Moslavačka");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedVideoFotoaparatiIndexSisackoMoslavackaUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
        ...
        public static async Task<List<AdData>> FotoaparatiIndexBjelovarskaMedimurskaVarazdinska(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Fotoaparati ads on Index in Bjelovarska, Međimurska and Varaždinska");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedFotoaparatiIndexBjelovarskaMedimurskaVarazdinskaUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
