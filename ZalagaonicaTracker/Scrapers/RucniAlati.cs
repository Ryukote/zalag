...
{
    public static class RucniAlati
    {
        ...
        private static string GetEncodedRucniAlatiIndexZagrebUrl(int page)
        {
            try
            {
        ...
        private static string GetRucniAlatiZagrebUrl(int page)
        {
            return $"https://www.njuskalo.hr/rucni-alati?geo%5BlocationIds%5D=1153&price%5Bmin%5D=50&page={page}";
        }

        private static string GetRucniAlatiKarlovacUrl(int page)
        {
            return $"https://www.njuskalo.hr/rucni-alati?geo%5BlocationIds%5D=1155&price%5Bmin%5D=50&page={page}";
        }

        private static string GetRucniAlatiRijekaIstraUrl(int page)
        {
            return $"https://www.njuskalo.hr/rucni-alati?geo%5BlocationIds%5D=1162%2C1154&price%5Bmin%5D=50&page={page}";
        }

        private static string GetRucniAlatiZadarLikaUrl(int page)
        {
            return $"https://www.njuskalo.hr/rucni-alati?geo%5BlocationIds%5D=1169%2C1158&price%5Bmin%5D=50&page={page}";
        }

        private static string GetRucniAlatiDubrovnikSplitUrl(int page)
        {
            return $"https://www.njuskalo.hr/rucni-alati?geo%5BlocationIds%5D=1152%2C1164&price%5Bmin%5D=50&page={page}";
        }

        private static string GetRucniAlatiKrapinskoZagorskaUrl(int page)
        {
            return $"https://www.njuskalo.hr/rucni-alati?geo%5BlocationIds%5D=1157&price%5Bmin%5D=50&page={page}";
        }

        private static string GetRucniAlatiSisackoMoslavackaUrl(int page)
        {
            return $"https://www.njuskalo.hr/rucni-alati?geo%5BlocationIds%5D=1163&price%5Bmin%5D=50&page={page}";
        }

        private static string GetRucniAlatiBjelovarskaMedimurskaVarazdinskaUrl(int page)
        {
            return $"https://www.njuskalo.hr/rucni-alati?geo%5BlocationIds%5D=1150%2C1159%2C1166&price%5Bmin%5D=50&page={page}";
        }
        ...
        private static async Task<AdData> GetAdInfo(AdData adData)
        {
            try
            {
                ...
                try
                {
                    ...
                    Console.WriteLine($"Connected! Navigating and scrapping Ručni alati ad detail on Index {adData.Location}");
        ...
        public static async Task<List<AdData>> RucniAlatiIndexZagreb(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Ručni alati ads on Index in Zagreb");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedRucniAlatiIndexZagrebUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
            ...
            //        while (true)
            //        {
            //            await pageInstance.GotoAsync(GetEncodedRucniAlatiIndexZagrebUrl(page), new() { Timeout = 30000 });
        ...
        public static async Task<List<AdData>> RucniAlatiIndexKarlovac(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Ručni alati ads on Index in Karlovac");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedLaptopiIndexKarlovacUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
            ...
            //        while (true)
            //        {
            //            await pageInstance.GotoAsync(GetEncodedLaptopiIndexKarlovacUrl(page), new() { Timeout = 30000 });
        ...
        public static async Task<List<AdData>> RucniAlatiIndexRijekaIstra(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Razglas ads on Index in Rijeka and Istra");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedLaptopiIndexRijekaIstraUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
            ...
            //        using var pw = await Playwright.CreateAsync();
            //        await using var browser = await pw.Chromium.ConnectOverCDPAsync(SBR_CDP);
            //        Console.WriteLine("Connected! Navigating and scrapping Ručni alati ads on Index in Rijeka and Istra");
            ...
            //        while (true)
            //        {
            //            await pageInstance.GotoAsync(GetEncodedLaptopiIndexRijekaIstraUrl(page), new() { Timeout = 30000 });
        ...
        public static async Task<List<AdData>> RucniAlatiIndexZadarLika(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Razglas ads on Index in Zadar and Lika");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedRucniAlatiIndexZadarLikaUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
            ...
            //        using var pw = await Playwright.CreateAsync();
            //        await using var browser = await pw.Chromium.ConnectOverCDPAsync(SBR_CDP);
            //        Console.WriteLine("Connected! Navigating and scrapping Ručni alati ads on Index in Zadar and Lika");
            ...
            //        while (true)
            //        {
            //            await pageInstance.GotoAsync(GetEncodedRucniAlatiIndexZadarLikaUrl(page), new() { Timeout = 30000 });
        ...
        public static async Task<List<AdData>> RucniAlatiIndexDubrovnikSplit(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Razglas ads on Index in Dubrovnik and Split");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedLaptopiIndexDubrovnikSplitUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
            ...
            //        using var pw = await Playwright.CreateAsync();
            //        await using var browser = await pw.Chromium.ConnectOverCDPAsync(SBR_CDP);
            //        Console.WriteLine("Connected! Navigating and scrapping Ručni alati ads on Index in Dubrovnik and Split");
            ...
            //        while (true)
            //        {
            //            await pageInstance.GotoAsync(GetEncodedLaptopiIndexDubrovnikSplitUrl(page), new() { Timeout = 30000 });
            ...
            //                //await SMSClient.SendSMS(adData.PhoneNumber, "098776677");
        ...
        public static async Task<List<AdData>> RucniAlatiIndexKrapinskoZagorska(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Razglas ads on Index in Krapinsko Zagorska");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedLaptopiIndexKrapinskoZagorskaUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
            ...
            //        using var pw = await Playwright.CreateAsync();
            //        await using var browser = await pw.Chromium.ConnectOverCDPAsync(SBR_CDP);
            //        Console.WriteLine("Connected! Navigating and scrapping Ručni alati ads on Index in Krapina and Zagorje");
            ...
            //        while (true)
            //        {
            //            await pageInstance.GotoAsync(GetEncodedLaptopiIndexKrapinskoZagorskaUrl(page), new() { Timeout = 30000 });
        ...
        public static async Task<List<AdData>> RucniAlatiIndexSisackoMoslavacka(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Ručni alati ads on Index in Sisačko Moslavačka");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedRucniAlatiIndexSisackoMoslavackaUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
            ...
            //        using var pw = await Playwright.CreateAsync();
            //        await using var browser = await pw.Chromium.ConnectOverCDPAsync(SBR_CDP);
            //        Console.WriteLine("Connected! Navigating and scrapping Ručni alati ads on Index in Sisak and Moslavina");
            ...
            //        while (true)
            //        {
            //            await pageInstance.GotoAsync(GetEncodedRucniAlatiIndexSisackoMoslavackaUrl(page), new() { Timeout = 30000 });
        ...
        public static async Task<List<AdData>> RucniAlatiIndexBjelovarskaMedimurskaVarazdinska(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Ručni alati ads on Index in Bjelovarska, Međimurska and Varaždinska");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedRucniAlatiIndexBjelovarskaMedimurskaVarazdinskaUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
            ...
            //        using var pw = await Playwright.CreateAsync();
            //        await using var browser = await pw.Chromium.ConnectOverCDPAsync(SBR_CDP);
            //        Console.WriteLine("Connected! Navigating and scrapping Ručni alati ads on Index in Bjelovarska, Međimurska and Varaždinska županija");
            ...
            //        while (true)
            //        {
            //            await pageInstance.GotoAsync(GetEncodedRucniAlatiIndexBjelovarskaMedimurskaVarazdinskaUrl(page), new() { Timeout = 30000 });
        ...
        public static async Task<List<AdData>> GetNjuskaloRucniAlatiZagreb()
        {
            return await GetNjuskaloData(GetRucniAlatiZagrebUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloRucniAlatiKarlovac()
        {
            return await GetNjuskaloData(GetRucniAlatiKarlovacUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloRucniAlatiRijekaIstra()
        {
            return await GetNjuskaloData(GetRucniAlatiRijekaIstraUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloRucniAlatiZadarLika()
        {
            return await GetNjuskaloData(GetRucniAlatiZadarLikaUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloRucniAlatiDubrovnikSplit()
        {
            return await GetNjuskaloData(GetRucniAlatiDubrovnikSplitUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloRucniAlatiKrapinskoZagorska()
        {
            return await GetNjuskaloData(GetRucniAlatiKrapinskoZagorskaUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloRucniAlatiSisackoMoslavacka()
        {
            return await GetNjuskaloData(GetRucniAlatiSisackoMoslavackaUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloRucniAlatiBjelovarskaMedimurskaVarazdinska()
        {
            return await GetNjuskaloData(GetRucniAlatiBjelovarskaMedimurskaVarazdinskaUrl(1), 1);
        }
    }
}
