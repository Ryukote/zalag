...
namespace ZalagaonicaTracker.Scrapers
{
    public static class Tableti
    {
        ...
        private static string GetEncodedTabletiIndexZagrebUrl(int page)
        {
            try
            {
        ...
        private static string GetEncodedTabletiIndexKarlovacUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedTabletiIndexRijekaIstraUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedTabletiIndexZadarLikaUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedTabletiIndexDubrovnikSplitUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedTabletiIndexKrapinskoZagorskaUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedTabletiIndexSisackoMoslavackaUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedTabletiIndexBjelovarskaMedimurskaVarazdinskaUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetTabletiZagrebUrl(int page)
        {
            return $"https://www.njuskalo.hr/tablet-pc?geo%5BlocationIds%5D=1153&price%5Bmin%5D=30&page={page}";
        }

        private static string GetTabletiKarlovacUrl(int page)
        {
            return $"https://www.njuskalo.hr/tablet-pc?geo%5BlocationIds%5D=1155&price%5Bmin%5D=30&page={page}";
        }

        private static string GetTabletiRijekaIstraUrl(int page)
        {
            return $"https://www.njuskalo.hr/tablet-pc?geo%5BlocationIds%5D=1162%2C1154&price%5Bmin%5D=30&page={page}";
        }

        private static string GetTabletiZadarLikaUrl(int page)
        {
            return $"https://www.njuskalo.hr/tablet-pc?geo%5BlocationIds%5D=1169%2C1158&price%5Bmin%5D=30&page={page}";
        }

        private static string GetTabletiDubrovnikSplitUrl(int page)
        {
            return $"https://www.njuskalo.hr/tablet-pc?geo%5BlocationIds%5D=1152%2C1164&price%5Bmin%5D=30&page={page}";
        }

        private static string GetTabletiKrapinskoZagorskaUrl(int page)
        {
            return $"https://www.njuskalo.hr/tablet-pc?geo%5BlocationIds%5D=1157&price%5Bmin%5D=30&page={page}";
        }

        private static string GetTabletiSisackoMoslavackaUrl(int page)
        {
            return $"https://www.njuskalo.hr/tablet-pc?geo%5BlocationIds%5D=1163&price%5Bmin%5D=30&page={page}";
        }

        private static string GetTabletiBjelovarskaMedimurskaVarazdinskaUrl(int page)
        {
            return $"https://www.njuskalo.hr/tablet-pc?geo%5BlocationIds%5D=1150%2C1159%2C1166&price%5Bmin%5D=30&page={page}";
        }
        ...
        private static async Task<AdData> GetAdInfo(AdData adData)
        {
            try
            {
                ...
                try
                {
                    ...
                    Console.WriteLine($"Connected! Navigating and scrapping Tableti ad detail on Index {adData.Location}");
        ...
        public static async Task<List<AdData>> TabletiIndexZagreb(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Tableti ads on Index in Zagreb");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedTabletiIndexZagrebUrl(page), new NavigationOptions
                        {
            ...
            //        while (true)
            //        {
            //            await pageInstance.GotoAsync(GetEncodedTabletiIndexZagrebUrl(page), new() { Timeout = 30000 });
        ...
        public static async Task<List<AdData>> TabletiIndexKarlovac(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Tableti ads on Index in Karlovac");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedTabletiIndexKarlovacUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
            ...
            //        while (true)
            //        {
            //            await pageInstance.GotoAsync(GetEncodedTabletiIndexKarlovacUrl(page), new() { Timeout = 30000 });
        ...
        public static async Task<List<AdData>> TabletiIndexRijekaIstra(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Tableti ads on Index in Rijeka and Istra");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedTabletiIndexRijekaIstraUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
            ...
            //        while (true)
            //        {
            //            await pageInstance.GotoAsync(GetEncodedTabletiIndexRijekaIstraUrl(page), new() { Timeout = 30000 });
        ...
        public static async Task<List<AdData>> TabletiIndexZadarLika(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Tableti ads on Index in Zadar and Lika");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedTabletiIndexZadarLikaUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
            ...
            //        while (true)
            //        {
            //            await pageInstance.GotoAsync(GetEncodedTabletiIndexZadarLikaUrl(page), new() { Timeout = 30000 });
        ...
        public static async Task<List<AdData>> TabletiIndexDubrovnikSplit(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedTabletiIndexDubrovnikSplitUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
            ...
            //        while (true)
            //        {
            //            await pageInstance.GotoAsync(GetEncodedTabletiIndexDubrovnikSplitUrl(page), new() { Timeout = 30000 });
        ...
        public static async Task<List<AdData>> TabletiIndexKrapinskoZagorska(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Tableti ads on Index in Krapinsko Zagorska");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedTabletiIndexKrapinskoZagorskaUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
            ...
            //        while (true)
            //        {
            //            await pageInstance.GotoAsync(GetEncodedTabletiIndexKrapinskoZagorskaUrl(page), new() { Timeout = 30000 });
        ...
        public static async Task<List<AdData>> TabletiIndexSisackoMoslavacka(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Tableti ads on Index in Sisačko Moslavačka");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedTabletiIndexSisackoMoslavackaUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
            ...
            //        while (true)
            //        {
            //            await pageInstance.GotoAsync(GetEncodedTabletiIndexSisackoMoslavackaUrl(page), new() { Timeout = 30000 });
        ...
        public static async Task<List<AdData>> TabletiIndexBjelovarskaMedimurskaVarazdinska(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Tableti ads on Index in Bjelovarska, Međimurska and Varaždinska");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedTabletiIndexBjelovarskaMedimurskaVarazdinskaUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
            ...
            //        while (true)
            //        {
            //            await pageInstance.GotoAsync(GetEncodedTabletiIndexBjelovarskaMedimurskaVarazdinskaUrl(page), new() { Timeout = 30000 });
        ...
        public static async Task<List<AdData>> GetNjuskaloTabletiZagreb()
        {
            return await GetNjuskaloData(GetTabletiZagrebUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloTabletiKarlovac()
        {
            return await GetNjuskaloData(GetTabletiKarlovacUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloTabletiRijekaIstra()
        {
            return await GetNjuskaloData(GetTabletiRijekaIstraUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloTabletiZadarLika()
        {
            return await GetNjuskaloData(GetTabletiZadarLikaUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloTabletiDubrovnikSplit()
        {
            return await GetNjuskaloData(GetTabletiDubrovnikSplitUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloTabletiKrapinskoZagorska()
        {
            return await GetNjuskaloData(GetTabletiKrapinskoZagorskaUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloTabletiSisackoMoslavacka()
        {
            return await GetNjuskaloData(GetTabletiSisackoMoslavackaUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloTabletiBjelovarskaMedimurskaVarazdinska()
        {
            return await GetNjuskaloData(GetTabletiBjelovarskaMedimurskaVarazdinskaUrl(1), 1);
        }
    }
}
