...
namespace ZalagaonicaTracker.Scrapers
{
    public static class Laptopi
    {
        ...
        private static string GetEncodedLaptopiIndexZagrebUrl(int page)
        {
            try
            {
        ...
        private static string GetEncodedLaptopiIndexZadarLikaUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedLaptopiIndexSisackoMoslavackaUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedLaptopiIndexBjelovarskaMedimurskaVarazdinskaUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetLaptopiZagrebUrl(int page)
        {
            return $"https://www.njuskalo.hr/prijenosna-racunala?geo%5BlocationIds%5D=1153&price%5Bmin%5D=100&page={page}";
        }

        private static string GetLaptopiaKarlovacUrl(int page)
        {
            return $"https://www.njuskalo.hr/prijenosna-racunala?geo%5BlocationIds%5D=1155&price%5Bmin%5D=100&page={page}";
        }

        private static string GetLaptopiRijekaIstraUrl(int page)
        {
            return $"https://www.njuskalo.hr/prijenosna-racunala?geo%5BlocationIds%5D=1162%2C1154&price%5Bmin%5D=100&page={page}";
        }

        private static string GetLaptopiZadarLikaUrl(int page)
        {
            return $"https://www.njuskalo.hr/prijenosna-racunala?geo%5BlocationIds%5D=1169%2C1158&price%5Bmin%5D=100&page={page}";
        }

        private static string GetLaptopiDubrovnikSplitUrl(int page)
        {
            return $"https://www.njuskalo.hr/prijenosna-racunala?geo%5BlocationIds%5D=1152%2C1164&price%5Bmin%5D=100&page={page}";
        }

        private static string GetLaptopiKrapinskoZagorskaUrl(int page)
        {
            return $"https://www.njuskalo.hr/prijenosna-racunala?geo%5BlocationIds%5D=1157&price%5Bmin%5D=100&page={page}";
        }

        private static string GetLaptopiSisackoMoslavackaUrl(int page)
        {
            return $"https://www.njuskalo.hr/prijenosna-racunala?geo%5BlocationIds%5D=1163&price%5Bmin%5D=100&page={page}";
        }

        private static string GetLaptopiBjelovarskaMedimurskaVarazdinskaUrl(int page)
        {
            return $"https://www.njuskalo.hr/prijenosna-racunala?geo%5BlocationIds%5D=1150%2C1159%2C1166&price%5Bmin%5D=100&page={page}";
        }
        ...
        private static async Task<AdData> GetAdInfo(AdData adData)
        {
            try
            {
                ...
                try
                {
                    ...
                    Console.WriteLine($"Connected! Navigating and scrapping Laptopi ad detail on Index {adData.Location}");
        ...
        public static async Task<List<AdData>> LaptopiIndexZagreb(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Laptopi ads on Index in Zagreb");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedLaptopiIndexZagrebUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
        ...
        public static async Task<List<AdData>> LaptopiIndexKarlovac(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Laptopi ads on Index in Karlovac");
        ...
        public static async Task<List<AdData>> LaptopiIndexRijekaIstra(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Laptopi ads on Index in Rijeka and Istra");
        ...
        public static async Task<List<AdData>> LaptopiIndexZadarLika(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Laptopi ads on Index in Zadar and Lika");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedLaptopiIndexZadarLikaUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
        ...
        public static async Task<List<AdData>> LaptopiIndexDubrovnikSplit(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Laptopi ads on Index in Dubrovnik and Split");
        ...
        public static async Task<List<AdData>> LaptopiIndexKrapinskoZagorska(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Laptopi ads on Index in Krapinsko Zagorska");
        ...
        public static async Task<List<AdData>> LaptopiIndexSisackoMoslavacka(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Laptopi ads on Index in Sisačko Moslavačka");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedLaptopiIndexSisackoMoslavackaUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
        ...
        public static async Task<List<AdData>> LaptopiIndexBjelovarskaMedimurskaVarazdinska(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Laptopi ads on Index in Bjelovarska, Međimurska and Varaždinska");
                ...
                while (hasAds)
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedLaptopiIndexBjelovarskaMedimurskaVarazdinskaUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
            ...
            //        while (true)
            //        {
            //            await pageInstance.GotoAsync(GetEncodedLaptopiIndexBjelovarskaMedimurskaVarazdinskaUrl(page), new() { Timeout = 30000 });
        ...
        public static async Task<List<AdData>> GetNjuskaloLaptopiZagreb()
        {
            return await GetNjuskaloData(GetLaptopiZagrebUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloLaptopiKarlovac()
        {
            return await GetNjuskaloData(GetLaptopiaKarlovacUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloLaptopiRijekaIstra()
        {
            return await GetNjuskaloData(GetLaptopiRijekaIstraUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloLaptopiZadarLika()
        {
            return await GetNjuskaloData(GetLaptopiZadarLikaUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloLaptopiDubrovnikSplit()
        {
            return await GetNjuskaloData(GetLaptopiDubrovnikSplitUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloLaptopiKrapinskoZagorska()
        {
            return await GetNjuskaloData(GetLaptopiKrapinskoZagorskaUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloLaptopiSisackoMoslavacka()
        {
            return await GetNjuskaloData(GetLaptopiSisackoMoslavackaUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloLaptopiBjelovarskaMedimurskaVarazdinska()
        {
            return await GetNjuskaloData(GetLaptopiBjelovarskaMedimurskaVarazdinskaUrl(1), 1);
        }
    }
}
