...
{
    public static class ModniDodaci
    {
        ...
        private static string GetEncodedModniDodaciIndexZagrebUrl(int page)
        {
            try
            {
        ...
        private static string GetEncodedModniDodaciIndexKarlovacUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedModniDodaciIndexRijekaIstraUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedModniDodaciIndexZadarLikaUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedModniDodaciIndexDubrovnikSplitUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedModniDodaciIndexKrapinskoZagorskaUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedModniDodaciIndexSisackoMoslavackaUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedModniDodaciIndexBjelovarskaMedimurskaVarazdinskaUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetModniDodaciZagrebUrl(int page)
        {
            return $"https://www.njuskalo.hr/rucni-alati?geo%5BlocationIds%5D=1153&price%5Bmin%5D=200&page={page}";
        }

        private static string GetModniDodaciKarlovacUrl(int page)
        {
            return $"https://www.njuskalo.hr/rucni-alati?geo%5BlocationIds%5D=1155&price%5Bmin%5D=200&page={page}";
        }

        private static string GetModniDodaciRijekaIstraUrl(int page)
        {
            return $"https://www.njuskalo.hr/rucni-alati?geo%5BlocationIds%5D=1162%2C1154&price%5Bmin%5D=200&page={page}";
        }

        private static string GetModniDodaciZadarLikaUrl(int page)
        {
            return $"https://www.njuskalo.hr/rucni-alati?geo%5BlocationIds%5D=1169%2C1158&price%5Bmin%5D=200&page={page}";
        }

        private static string GetModniDodaciDubrovnikSplitUrl(int page)
        {
            return $"https://www.njuskalo.hr/rucni-alati?geo%5BlocationIds%5D=1152%2C1164&price%5Bmin%5D=200&page={page}";
        }

        private static string GetModniDodaciKrapinskoZagorskaUrl(int page)
        {
            return $"https://www.njuskalo.hr/rucni-alati?geo%5BlocationIds%5D=1157&price%5Bmin%5D=200&page={page}";
        }

        private static string GetModniDodaciSisackoMoslavackaUrl(int page)
        {
            return $"https://www.njuskalo.hr/rucni-alati?geo%5BlocationIds%5D=1163&price%5Bmin%5D=200&page={page}";
        }

        private static string GetModniDodaciBjelovarskaMedimurskaVarazdinskaUrl(int page)
        {
            return $"https://www.njuskalo.hr/rucni-alati?geo%5BlocationIds%5D=1150%2C1159%2C1166&price%5Bmin%5D=200&page={page}";
        }
        ...
        private static async Task<AdData> GetAdInfo(AdData adData)
        {
            try
            {
                ...
                try
                {
                    ...
                    Console.WriteLine($"Connected! Navigating and scrapping Modni dodaci ad detail on Index {adData.Location}");
        ...
        public static async Task<List<AdData>> ModniDodaciIndexZagreb(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Modni dodaci ads on Index in Zagreb");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedModniDodaciIndexZagrebUrl(page), new NavigationOptions
                        {
        ...
        public static async Task<List<AdData>> ModniDodaciIndexKarlovac(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Modni dodaci ads on Index in Karlovac");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedModniDodaciIndexKarlovacUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
        ...
        public static async Task<List<AdData>> ModniDodaciIndexRijekaIstra(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Modni dodaci ads on Index in Rijeka and Istra");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedModniDodaciIndexRijekaIstraUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
            ...
            //        while (true)
            //        {
            //            await pageInstance.GotoAsync(GetEncodedModniDodaciIndexRijekaIstraUrl(page), new() { Timeout = 30000 });
        ...
        public static async Task<List<AdData>> ModniDodaciIndexZadarLika(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Modni dodaci ads on Index in Zadar and Lika");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedModniDodaciIndexZadarLikaUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
            ...
            //        while (true)
            //        {
            //            await pageInstance.GotoAsync(GetEncodedModniDodaciIndexZadarLikaUrl(page), new() { Timeout = 30000 });
        ...
        public static async Task<List<AdData>> ModniDodaciIndexDubrovnikSplit(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Modni dodaci ads on Index in Dubrovnik and Split");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedModniDodaciIndexDubrovnikSplitUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
        ...
        public static async Task<List<AdData>> ModniDodaciIndexKrapinskoZagorska(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Modni dodaci ads on Index in Krapinsko Zagorska");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedModniDodaciIndexKrapinskoZagorskaUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
            ...
            //        using var pw = await Playwright.CreateAsync();
            //        await using var browser = await pw.Chromium.ConnectOverCDPAsync(SBR_CDP);
            //        Console.WriteLine("Connected! Navigating and scrapping Modni dodaci ads on Index in Krapina and Zagorje");
            ...
            //        while (true)
            //        {
            //            await pageInstance.GotoAsync(GetEncodedModniDodaciIndexKrapinskoZagorskaUrl(page), new() { Timeout = 30000 });
        ...
        public static async Task<List<AdData>> ModniDodaciIndexSisackoMoslavacka(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Modni dodaci ads on Index in Sisačko Moslavačka");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedModniDodaciIndexSisackoMoslavackaUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
            ...
            //        using var pw = await Playwright.CreateAsync();
            //        await using var browser = await pw.Chromium.ConnectOverCDPAsync(SBR_CDP);
            //        Console.WriteLine("Connected! Navigating and scrapping Modni dodaci ads on Index in Sisak and Moslavina");
            ...
            //        while (true)
            //        {
            //            await pageInstance.GotoAsync(GetEncodedModniDodaciIndexSisackoMoslavackaUrl(page), new() { Timeout = 30000 });
        ...
        public static async Task<List<AdData>> ModniDodaciIndexBjelovarskaMedimurskaVarazdinska(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Modni dodaci ads on Index in Bjelovarska, Međimurska and Varaždinska");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedModniDodaciIndexBjelovarskaMedimurskaVarazdinskaUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
        ...
        public static async Task<List<AdData>> GetNjuskaloModniDodaciZagreb()
        {
            return await GetNjuskaloData(GetModniDodaciZagrebUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloModniDodaciKarlovac()
        {
            return await GetNjuskaloData(GetModniDodaciKarlovacUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloModniDodaciRijekaIstra()
        {
            return await GetNjuskaloData(GetModniDodaciRijekaIstraUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloModniDodaciZadarLika()
        {
            return await GetNjuskaloData(GetModniDodaciZadarLikaUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloModniDodaciDubrovnikSplit()
        {
            return await GetNjuskaloData(GetModniDodaciDubrovnikSplitUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloModniDodaciKrapinskoZagorska()
        {
            return await GetNjuskaloData(GetModniDodaciKrapinskoZagorskaUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloModniDodaciSisackoMoslavacka()
        {
            return await GetNjuskaloData(GetModniDodaciSisackoMoslavackaUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloModniDodaciBjelovarskaMedimurskaVarazdinska()
        {
            return await GetNjuskaloData(GetModniDodaciBjelovarskaMedimurskaVarazdinskaUrl(1), 1);
        }
    }
}
