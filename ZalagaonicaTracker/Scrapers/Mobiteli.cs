...
namespace ZalagaonicaTracker.Scrapers
{
    public static class Mobiteli
    {
        ...
        private static string GetMobiteliZagrebUrl(int page)
        {
            return $"https://www.njuskalo.hr/mobiteli?geo%5BlocationIds%5D=1153&price%5Bmin%5D=100&page={page}";
        }

        private static string GetMobiteliKarlovacUrl(int page)
        {
            return $"https://www.njuskalo.hr/mobiteli?geo%5BlocationIds%5D=1155&price%5Bmin%5D=100&page={page}";
        }

        private static string GetMobiteliRijekaIstraUrl(int page)
        {
            return $"https://www.njuskalo.hr/mobiteli?geo%5BlocationIds%5D=1162%2C1154&price%5Bmin%5D=100&page={page}";
        }

        private static string GetMobiteliZadarLikaUrl(int page)
        {
            return $"https://www.njuskalo.hr/mobiteli?geo%5BlocationIds%5D=1169%2C1158&price%5Bmin%5D=100&page={page}";
        }

        private static string GetMobiteliDubrovnikSplitUrl(int page)
        {
            return $"https://www.njuskalo.hr/mobiteli?geo%5BlocationIds%5D=1152%2C1164&price%5Bmin%5D=100&page={page}";
        }

        private static string GetMobiteliKrapinskoZagorskaUrl(int page)
        {
            return $"https://www.njuskalo.hr/mobiteli?geo%5BlocationIds%5D=1157&price%5Bmin%5D=100&page={page}";
        }

        private static string GetMobiteliSisackoMoslavackaUrl(int page)
        {
            return $"https://www.njuskalo.hr/mobiteli?geo%5BlocationIds%5D=1163&price%5Bmin%5D=100&page={page}";
        }

        private static string GetMobiteliBjelovarskaMedimurskaVarazdinskaUrl(int page)
        {
            return $"https://www.njuskalo.hr/mobiteli?geo%5BlocationIds%5D=1150%2C1159%2C1166&price%5Bmin%5D=100&page={page}";
        }

        private static string GetEncodedSamsungMobiteliIndexZagrebUrl(int page)
        {
            try
            {
        ...
        private static string GetEncodedIPhoneMobiteliIndexZagrebUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedSamsungMobiteliIndexKarlovacUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedIPhoneMobiteliIndexKarlovacUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedSamsungMobiteliIndexRijekaIstraUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedIPhoneMobiteliIndexRijekaIstraUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedSamsungMobiteliIndexZadarLikaUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedIPhoneMobiteliIndexZadarLikaUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedSamsungMobiteliIndexDubrovnikSplitUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedIPhoneMobiteliIndexDubrovnikSplitUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedSamsungMobiteliIndexKrapinskoZagorskaUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedIPhoneMobiteliIndexKrapinskoZagorskaUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedSamsungMobiteliIndexSisackoMoslavackaUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedIPhoneMobiteliIndexSisackoMoslavackaUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedSamsungMobiteliIndexBjelovarskaMedimurskaVarazdinskaUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedIPhoneMobiteliIndexBjelovarskaMedimurskaVarazdinskaUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedLaptopiIndexKarlovacUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
                        ...
                        if (match.Success)
                        {
                            ...
                            if (phones != null)
                            {
                                ...
                                foreach (var phone in phones)
                                {
                                    ...
                                    if (!string.IsNullOrEmpty(href) && ((href == "+385959066565") || (href == "+385921500521")))
                                    {
                                        return adData;
                                    }
        ...
        public static async Task<List<AdData>> MobiteliSamsungIndexZagreb(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Samsung mobiteli ads on Index in Zagreb");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedSamsungMobiteliIndexZagrebUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
        ...
        public static async Task<List<AdData>> MobiteliIPhoneIndexZagreb(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping iPhone mobiteli ads on Index in Zagreb");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedIPhoneMobiteliIndexZagrebUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
                        ...
                        foreach (var ad in ads)
                        {
                            ...
                            // Send SMS only if the phone number is new
                            if (!string.IsNullOrEmpty(adData.PhoneNumber) && !string.IsNullOrEmpty(adData.PhoneNumber) && !sentNumbers.Contains(adData.PhoneNumber))
                            {
                                string smsNumber = GetSMSNumberForLocation(adData.Location);
                                if (smsNumber != null)
                                {
        ...
        public static async Task<List<AdData>> MobiteliSamsungIndexDubrovnikSplit(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Samsung mobiteli ads on Index in Dubrovnik and Split");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedSamsungMobiteliIndexDubrovnikSplitUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
        ...
        public static async Task<List<AdData>> MobiteliIPhoneIndexDubrovnikSplit(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping iPhone mobiteli ads on Index in Dubrovnik and Split");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedIPhoneMobiteliIndexDubrovnikSplitUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
        ...
        public static async Task<List<AdData>> MobiteliSamsungIndexKarlovac(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Samsung mobiteli ads on Index in Karlovac");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedSamsungMobiteliIndexKarlovacUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
        ...
        public static async Task<List<AdData>> MobiteliIPhoneIndexKarlovac(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping iPhone mobiteli ads on Index in Karlovac");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedIPhoneMobiteliIndexKarlovacUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
        ...
        public static async Task<List<AdData>> MobiteliSamsungIndexKrapinskoZagorska(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Samsung mobiteli ads on Index in Krapinsko Zagorska");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedSamsungMobiteliIndexKrapinskoZagorskaUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
        ...
        public static async Task<List<AdData>> MobiteliIPhoneIndexKrapinskoZagorska(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping iPhone mobiteli ads on Index in Krapinsko Zagorska");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedIPhoneMobiteliIndexKrapinskoZagorskaUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
        ...
        public static async Task<List<AdData>> MobiteliSamsungIndexRijekaIstra(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Samsung mobiteli ads on Index in Rijeka and Istra");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedSamsungMobiteliIndexRijekaIstraUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
        ...
        public static async Task<List<AdData>> MobiteliIPhoneIndexRijekaIstra(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping iPhone mobiteli ads on Index in Rijeka and Istra");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedIPhoneMobiteliIndexRijekaIstraUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
        ...
        public static async Task<List<AdData>> MobiteliSamsungIndexSisackoMoslavacka(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Samsung mobiteli ads on Index in Sisačko Moslavačka");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedSamsungMobiteliIndexSisackoMoslavackaUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
        ...
        public static async Task<List<AdData>> MobiteliIPhoneIndexSisackoMoslavacka(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping iPhone mobiteli ads on Index in Sisačko Moslavačka");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedIPhoneMobiteliIndexSisackoMoslavackaUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
        ...
        public static async Task<List<AdData>> MobiteliSamsungIndexZadarLika(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping Samsung mobiteli ads on Index in Zadar and Lika");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedSamsungMobiteliIndexZadarLikaUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
        ...
        public static async Task<List<AdData>> MobiteliIPhoneIndexZadarLika(List<AdData> scrapedAds, HashSet<string> sentNumbers, int page = 1)
        {
            try
            {
                Console.WriteLine("Connected! Navigating and scrapping iPhone mobiteli ads on Index in Zadar and Lika");
                ...
                while (hasAds) // Keep looping until no ads are found
                {
                    try
                    {
                        ...
                        var response = await browserPage.GoToAsync(GetEncodedIPhoneMobiteliIndexZadarLikaUrl(page), new NavigationOptions
                        {
                            WaitUntil = new[] { WaitUntilNavigation.Networkidle2 } // Ensures dynamic content is loaded
                        });
        ...
        private static string GetEncodedLaptopiIndexRijekaIstraUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedRucniAlatiIndexZadarLikaUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedLaptopiIndexDubrovnikSplitUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedLaptopiIndexKrapinskoZagorskaUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedRucniAlatiIndexSisackoMoslavackaUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        private static string GetEncodedRucniAlatiIndexBjelovarskaMedimurskaVarazdinskaUrl(int page)
        {
            try
            {
                string baseUrl = "https://www.index.hr/oglasi/pretraga?searchQuery=";
        ...
        public static async Task<List<AdData>> GetNjuskaloMobiteliZagreb()
        {
            return await GetNjuskaloData(GetMobiteliZagrebUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloMobiteliKarlovac()
        {
            return await GetNjuskaloData(GetMobiteliKarlovacUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloMobiteliRijekaIstra()
        {
            return await GetNjuskaloData(GetMobiteliRijekaIstraUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloMobiteliZadarLika()
        {
            return await GetNjuskaloData(GetMobiteliZadarLikaUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloMobiteliDubrovnikSplit()
        {
            return await GetNjuskaloData(GetMobiteliDubrovnikSplitUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloMobiteliKrapinskoZagorska()
        {
            return await GetNjuskaloData(GetMobiteliKrapinskoZagorskaUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloMobiteliSisackoMoslavacka()
        {
            return await GetNjuskaloData(GetMobiteliSisackoMoslavackaUrl(1), 1);
        }

        public static async Task<List<AdData>> GetNjuskaloMobiteliBjelovarskaMedimurskaVarazdinska()
        {
            return await GetNjuskaloData(GetMobiteliBjelovarskaMedimurskaVarazdinskaUrl(1), 1);
        }
    }
}
